...
- O que são?
    * Agrupamento, procedimentos, banco de dados, oferecidos para os tomadores de decisão (stakeholder)
    ...
    - Solução
        ...
        * Otimizar e centralizar o fluxo de informa~çoes
...
- Revoluções (principal foco na revolução tecnologica(3ª) e industri(4.0) - ver slides)
    ...
    - Ver slide com com figura
        * Entrar com dados (por meio de um usuário, sensor ou alguma outra coisa)
        * 
        * Controle e avaliação sobre o dados, para ver se é verdadeira, condiz, etc
    ...
    - Hardware
        ...
        * Papel crucial na distribuição de .... (sile)

    - Software

    - Dados
        * Valor número ou textual que foi adicionado pelko usuário ou coletado... (slide)
    ...
    - Tudo isso se resulta a que?
        ...
        * A era da informação é um termo utilizado para se referir à realidade tecnológica como mediadora das relações humanas e das interações entre máquinas - essas, ada vez mais autônomas
    
    #### Aulas (4???) Pilares da Transformação Digital - ver slides
    ...
    - Transformação digital
        ...
        * Isso envolve integração entre todos os setores( ver slides)
    ...
    - (3) IoT Internet das coisas
        * Conexão digital de coisas do cotidiano com a internet
        * Uma rede de objetos físicos capaz de reunir e transmitir dados
        * Exemplos (slide)
    ...
    - Pirâmide de Maslow
        ...
        * Meio: Quando uma solução já eixste para aquele problema, mas ela pode ser melhorada ou completamente substituída
    ...
    - Sistemas de Controle de Processos (SCP)
        * Tem o objetivo de monitorar e controlar processos físicos industriáis
    ...
    - Sistemas de Colaboração e Comunicação (SCC)
        * Tem a função de facilitar a comeunicação entre funcionários, equipes
            * Teams
            * Trello
            * Github, Gitlab
        * Principais características:
    ...
    - Sistemas Gerenciais
        * (SIG) - são projetados para fornecer informações e relatórios, para ajudar gerentes a tomar decisões fundamentais
    ...
    - 5 Categorias de Sistemas Gerenciais
        ...
        - Sistema de Gestão do Conhecimento (SGC)
            ...
            * Exemplos:
                ...
                * Wikis
            * Principais características
                * Suporte ao aprendizado organizacional
                * Categorização e busca de buscar (playlist youtube de treinamentos)
        ...
        - Sistemas de informações gerenciais podem compartilhar o banco dados com os sitemas operacionais
            * CLINIC Web - CLINIC Local
            * Vantagens: integração, concisão, simplicidade
            * Desvantagem: dependência

        - VERIFICAR EXERCÍCIOS FINAIS DOS SLIDES
    ...
    - ERP
        - Sistema de gestão empresarial .... (slide)
        - Características
    ...
    - PLM
        ...
        - Etapas
            * Ideia, estudo de viabilidade, .... (slide)
